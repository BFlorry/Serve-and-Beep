...
public class ChronoHelper : EditorWindow
{
    ...
    private const string kFiveButtonTitle = "×5";
    private const string kTenButtonTitle = "×10";
    ...
    private void CreateChronoButtons()
    {
        _chronoButtons = new ChronoButton[]{
            ...
            new ChronoButton(this, 5.000f, new GUIContent(kFiveButtonTitle)),
            new ChronoButton(this, 10.000f, new GUIContent(kTenButtonTitle))
        };
    }
    ...
    private void DrawChronoSlider()
    {
        using (new EditorGUILayout.HorizontalScope())
        {
            ...
            _chronoScale = EditorGUILayout.Slider(_chronoScale, 0.0f, 10.0f, kChronoSliderExpandWidth, kChronoSliderMaxWidth);
