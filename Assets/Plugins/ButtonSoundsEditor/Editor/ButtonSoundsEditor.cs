...
namespace Assets.Plugins.ButtonSoundsEditor.Editor
{
	public class ButtonSoundsEditor : EditorWindow, IComparer<GameObject>
	{
		...
		private AudioClip _deselectSound;
		...
		private void Initialize()
		{
			...
			_selectSound = GetFirstSelectSound(clickSounds);
			_deselectSound = GetFirstDeselectSound(clickSounds);
		}
		...
		private AudioClip GetFirstSelectSound(ButtonClickSound[] clickSounds)
		{
			ButtonClickSound buttonSelectSound = clickSounds.FirstOrDefault(_ => _.SelectSound != null);
			return buttonSelectSound == null ? null : buttonSelectSound.SelectSound;
		}

		private AudioClip GetFirstDeselectSound(ButtonClickSound[] clickSounds)
		{
			ButtonClickSound buttonDeselectSound = clickSounds.FirstOrDefault(_ => _.DeselectSound != null);
			return buttonDeselectSound == null ? null : buttonDeselectSound.DeselectSound;
		}
